(function () {
    ...
    getProduct.$inject = ['util','$scope','$rootScope','GlobalVariable', 'StoreService', '$state', 'AppState','RestrictedCharacter.Types'];

    function getProduct(util,$scope,$rootScope,GlobalVariable, StoreService, $state, AppState,restrictCharacter) {
